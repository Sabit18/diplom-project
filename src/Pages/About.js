...
document.body.style.backgroundImage = "url('https://clarionschooldubai.com/wp-content/uploads/2017/05/bg-grey.jpg')";
		  	...
		  	<Row>
		  		...
		  		<Col sm={9}>
		  			<Tab.Content className="mt-3">
		  				<Tab.Pane style={center} eventKey="first">
                         ...
                         <img style={tabStyle} src="https://www.azernews.az/media/2016/08/26/gabala_1.jpg" circleRounded/>
                			<p>
