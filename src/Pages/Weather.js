...
state = {
  ...
  const apiUrl = await 
  fetch(`https://cors-anywhere.herokuapp.com/http://api.openweathermap.org/data/2.5/weather?q=${city}&appid=${API_KEY}&units=metric`);   
		...
		return (
			<div className="wrapper">
 			<div className="main">
					...
					<div className="inputStyle col-sm-7">         
